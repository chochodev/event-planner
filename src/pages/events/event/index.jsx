    ...
    <HomeLayout>
      <div className='w-full min-h-screen text-gray-800 py-[4rem] font-poppins '>
        ...
        <div className='relative flex justify-between max-lg:flex-col gap-y-[3rem] max-w-[75rem] mx-auto p-[2rem] lg:px-[4rem]'>
          {/* :::::::::::::::::::::::: IMAGE INFO */}
          <div className='lg:sticky top-[2rem] left-0 flex flex-col w-full lg:w-[55%] lg:h-[50rem] rounded-[16px] overflow-hidden shadow-[0_0_4px_2px_rgba(150,150,255,0.2)] '>
            {!loading &&
            <img
            ...
            <div className='relative w-full h-0 '>
              ...
              <img
                src={imageUrl || '/assets/images/lady-with-glass.webp'}
                alt='Event'
                className='absolute z-[1] bottom-0 left-0 blur-[4px] w-full h-[50rem] brightness-[0.5] object-cover '
              /> :
