  ...
  return (
    <div className='flex flex-col items-start gap-[1rem] w-full'>
      ...
      <div className='flex flex-col xlg:flex-row justify-between gap-[1rem] w-full h-max '>
        <div className='flex flex-col gap-[2rem] items-start text-start xmd:max-xlg:text-center w-full xlg:w-[48%] py-[2rem] md:py-[4rem] '>
          <p 
            className='flex items-center xmd:max-xlg:mx-auto xmd:max-xlg:translate-x-[-1rem] font-dance text-[2rem] font-[600] text-secondary w-max'
          >
          ...
          <div className='flex flex-col gap-[1.5rem] w-full '>
            ...
            <div className='flex gap-[1rem] xmd:max-xlg:mx-auto w-max'>
              <div className='w-max'>
