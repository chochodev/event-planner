    ...
    <div className="w-[20rem] min-h-screen bg-gray-50 p-4 space-y-4">
      ...
      {selectedObject && (
        <div className="bg-white rounded-md shadow p-4 space-y-4">
          ...
          <CommonProperties properties={properties} updateObject={updateObject} />

          {objectType === 'circle' && (
            <CircleProperties properties={properties} updateObject={updateObject} />
          )}

          {objectType === 'rect' && (
            <RectangleProperties properties={properties} updateObject={updateObject} />
          )}
