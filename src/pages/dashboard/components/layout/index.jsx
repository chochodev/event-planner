  ...
  return (
    <div className='flex w-full'>
      <div className="flex flex-col w-full">
        <div className='w-full px-[2rem] lg:px-[4rem]'>
          {/* ::::::::::::::::: HEAD */}
        ...
        <div className='hidden xmd:flex items-center h-[4rem] w-full overflow-x-hidden shadow-[0_5px_15px_rgba(0,0,0,0.1)] '>
          {/* ::::::::::::::::: NAV MENU */}
          <nav className='flex gap-[0.875rem] md:gap-[1.5rem] max-w-[75rem] mx-auto '>
            {navLinks.map((nav, index) => (
              <Link 
                key={index}
                to={nav.link}
                className='flex items-center gap-[0.25rem] h-[2rem] px-[0.875rem] md:px-[1rem] text-[0.875rem] text-gray-500 hover:text-secondary-hover ease-250 '
              >
                {nav.icon}
                <p>{nav.name}</p>
              </Link>
